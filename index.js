...
Module['FS_createPath']("/", "data", true, true);
    ...
    loadPackage({"files": [{"filename": "/data/highscore", "start": 0, "end": 1}], "remote_package_size": 1});

  })();

// end include: /tmp/tmp2jluczg4.js
// include: /tmp/tmpufl44guu.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpufl44guu.js
// include: /tmp/tmp4nkyvfuc.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp4nkyvfuc.js
...
var ASM_CONSTS = {
 ...
 125172: ($0) => { return window.miniaudio.get_device_by_index($0).webaudio.sampleRate; },  
 125245: ($0) => { var device = window.miniaudio.get_device_by_index($0); if (device.scriptNode !== undefined) { device.scriptNode.onaudioprocess = function(e) {}; device.scriptNode.disconnect(); device.scriptNode = undefined; } if (device.streamNode !== undefined) { device.streamNode.disconnect(); device.streamNode = undefined; } device.webaudio.close(); device.webaudio = undefined; device.pDevice = undefined; },  
 125645: ($0) => { window.miniaudio.untrack_device_by_index($0); },  
 125695: ($0) => { var device = window.miniaudio.get_device_by_index($0); device.webaudio.resume(); device.state = window.miniaudio.device_state.started; },  
 125834: ($0) => { var device = window.miniaudio.get_device_by_index($0); device.webaudio.suspend(); device.state = window.miniaudio.device_state.stopped; },  
 125974: () => { if (document.fullscreenElement) return 1; },  
 126020: () => { return Module.canvas.width; },  
 126052: () => { return parseInt(Module.canvas.style.width); },  
 126100: () => { document.exitFullscreen(); },  
 126127: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 126199: () => { if (document.fullscreenElement) return 1; },  
 126245: () => { return Module.canvas.width; },  
 126277: () => { return screen.width; },  
 126302: () => { document.exitFullscreen(); },  
 126329: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 126462: () => { return window.innerWidth; },  
 126488: () => { return window.innerHeight; },  
 126515: () => { if (document.fullscreenElement) return 1; },  
 126561: () => { return Module.canvas.width; },  
 126593: () => { return parseInt(Module.canvas.style.width); },  
 126641: () => { if (document.fullscreenElement) return 1; },  
 126687: () => { return Module.canvas.width; },  
 126719: () => { return screen.width; },  
 126744: () => { return window.innerWidth; },  
 126770: () => { return window.innerHeight; },  
 126797: () => { if (document.fullscreenElement) return 1; },  
 126843: () => { return Module.canvas.width; },  
 126875: () => { return screen.width; },  
 126900: () => { document.exitFullscreen(); },  
 126927: () => { if (document.fullscreenElement) return 1; },  
 126973: () => { return Module.canvas.width; },  
 127005: () => { return parseInt(Module.canvas.style.width); },  
 127053: () => { document.exitFullscreen(); },  
 127080: ($0) => { Module.canvas.style.opacity = $0; },  
 127118: () => { return screen.width; },  
 127143: () => { return screen.height; },  
 127169: () => { return window.screenX; },  
 127196: () => { return window.screenY; },  
 127223: () => { return window.devicePixelRatio; },  
 127259: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 127312: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 127363: () => { Module.canvas.style.cursor = 'none'; },  
 127400: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 127656: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 127707: () => { if (document.pointerLockElement) return 1; },  
 127754: () => { if (document.fullscreenElement) return 1; },  
 127800: () => { return window.innerWidth; },  
 127826: () => { return window.innerHeight; }
};
